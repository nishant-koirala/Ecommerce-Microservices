    ...
    <section class="relative overflow-hidden">
      ...
      >
        <div class="relative z-10">
          <p
            class="mb-5 inline-flex items-center gap-2 rounded-full border border-primary-200 bg-white/70 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-primary-700 backdrop-blur dark:border-primary-800 dark:bg-primary-950/50 dark:text-primary-300"
          >
          ...
          <h1
            class="font-display text-5xl font-medium leading-[1.04] tracking-tight text-neutral-900 dark:text-neutral-50 sm:text-6xl lg:text-7xl"
          >
            Essentials, <em class="italic text-primary-700 dark:text-primary-400">curated</em> with
            intention.
          </h1>

          <p class="mt-6 max-w-md text-lg leading-relaxed text-neutral-600 dark:text-neutral-300">
        ...
        <div class="relative h-[440px] lg:h-[540px]" aria-hidden="true">
          <img
            ...
            alt=""
            class="absolute right-0 top-0 h-[88%] w-3/4 rounded-[2rem] object-cover shadow-card"
            fetchpriority="high"
          />
          <img
            src="https://picsum.photos/seed/atelier-hero-accent/420/420"
            alt=""
            class="absolute bottom-0 left-2 h-[46%] w-[45%] rounded-3xl border-4 border-neutral-50 object-cover shadow-card dark:border-neutral-950"
            loading="lazy"
          />
          <div
